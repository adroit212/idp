                                ...
                                <div class="col-md-12">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($all_camps as $single_camp) {
                                                ?>
                                                <tr>
                                                    <td><?php echo $sn ?></td>  
                                                    <td><?php echo $single_camp['camp_name'] ?></td>  
                                                    <td><?php echo $single_camp['admin_fullname'] ?></td>  
                                                    <td><?php echo $single_camp['email'] ?></td>  
                                                    <td><?php echo $single_camp['mobile'] ?></td>  
                                                    <td><?php echo $single_camp['state'] ?></td>  
                                                    <td><?php echo $single_camp['lga'] ?></td>  
                                                    <td><?php echo $single_camp['address'] ?></td>  
                                                </tr>
                                                <?php
                                                $sn++;
                                            }
